...
$shareName         = "ReplData"
$machine           = $env:COMPUTERNAME  -- auto-resolved, no change needed

$repl_distribution = "$machine\repl_distribution"
$repl_merge        = "$machine\repl_merge"
$repl_snapshot     = "$machine\repl_snapshot"
